package com.shinelon.showpopwindow;
...
import com.shinelon.showpopwindow.adapter.CategoryListAdapter;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        iv_price_status = (ImageView) findViewById(R.id.iv_price_status);
    ...
    private void showPopupWindow(int width, int height) {
        ...
        CategoryListAdapter cla = new CategoryListAdapter(MainActivity.this,
                itemList);
